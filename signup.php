...
<body class="align">
    ...
    <div class="grid">
      ...
      <form action="proses-signup.php" method="POST" class="form login">
  
        <div class="form__field">
          <label for="first_name"><svg class="icon">
              <use xlink:href="#icon-user"></use>
            </svg><span class="hidden">First Name</span></label>
          <input autocomplete="username" id="first_name" type="text" name="first_name" class="form__input" placeholder="firstname" required>
        </div>
        ...
        <div class="form__field">
            ...
            <input autocomplete="username" id="last_name" type="text" name="last_name" class="form__input" placeholder="lastname" required>
          </div>

          <div class="form__field">
            <label for="username"><svg class="icon">
                <use xlink:href="#icon-user"></use>
              </svg><span class="hidden">Userame</span></label>
        ...
        <div class="form__field">
          ...
          <input id="signup__password" type="password" name="confirm_password" class="form__input" placeholder="Confirm Password" required>
        </div>
      ...
      <p class="text--center">Forgot Password ? <a href="#">Reset</a> <svg class="icon">
